...
# Pin npm to v11 — package-lock.json is generated by npm 11 and contains
# entries that older npm (10.9.x ships with node:22-alpine) misinterprets.
...
# Pin npm to v11 (see proxy-builder stage)
RUN npm install -g npm@^11
