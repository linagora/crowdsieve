...
export default async function AlertDetailPage({ params }: AlertDetailPageProps) {
  ...
  return (
    <div className="space-y-6">
      {/* Back link */}
      <Link href="/alerts" className="text-crowdsec-primary hover:underline flex items-center gap-2">
        ...
        <div className="card p-6">
          ...
          <dl className="space-y-3">
            <div className="flex justify-between">
              ...
              <dd>
                {alert.geoCountryCode && (
                  <span className="mr-2">{alert.geoCountryCode}</span>
                )}
